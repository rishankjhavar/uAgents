...
SEED_PHRASE = "SEED_PHRASE" # You can change this seed phrase.
print(f"Your agent's address is: {Agent(seed=SEED_PHRASE).address}")

AGENT_MAILBOX_KEY = "AGENT_MAILBOX_KEY" # Replace this with the mailbox key you obtained from Agentverse.
